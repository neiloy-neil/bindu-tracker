...
create trigger trg_aggregate_production
  after insert or update or delete
  on production_entries
  for each row
  execute function aggregate_production_entries();

-- Backfill existing data by causing the trigger to fire for all current entries
update production_entries set id = id;
